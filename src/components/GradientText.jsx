...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative inline-flex items-center max-w-fit rounded-[1.25rem] font-medium transition-shadow duration-500 overflow-hidden ${showBorder ? "py-1 px-2" : ""} ${className}`}
